...
class Users(models.Model):    
    ...
    confirmPass=models.TextField()
    mobilPhone=models.TextField()
    photo=models.ImageField(blank=False, null=False, upload_to='user/images')
    ...
    @classmethod
    def userUpdate(self,request,id):
        u=self.userDetails(id)
        u.firstName=request.POST['uFirstName']
        u.lastName=request.POST['uLastName']
        u.email=request.POST['uEmail']
        u.password=request.POST['uPassword']
        u.confirmPass=request.POST['uConfirmPass']
        u.mobilPhone=request.POST['uMobilPhone']
        u.photo=request.FILES['uImage']
        u.save()
